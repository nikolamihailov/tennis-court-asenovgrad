    ...
    <header className="sticky top-0 z-50 border-b border-white/5 bg-navy-900/95 backdrop-blur">
      <nav className="relative mx-auto flex h-(--header-h) max-w-7xl items-center justify-between gap-4 px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {/* First, ahead of the account controls, so the account group stays together
              at the edge with sign-out rightmost. Hidden wherever the hamburger is
              shown: below lg the bar was a logo, a green button and a burger fighting
              over a narrow strip, and the action is already covered twice — by the
              Hero's own CTA immediately below and by the menu panel. */}
          <Link
            href="/booking"
